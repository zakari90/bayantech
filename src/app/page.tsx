...
export default function RootPage() {
  ...
  return (
    <main
      dir="rtl"
      className="min-h-screen w-full flex flex-col items-center justify-center p-4 bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-hidden font-sans selection:bg-blue-500/30"
    >
      ...
      <div className="relative z-10 w-full max-w-md mx-auto p-8 sm:p-10 rounded-3xl bg-slate-900/80 backdrop-blur-xl border border-slate-800 shadow-2xl shadow-black/60 text-center flex flex-col items-center">
        ...
        <div className="relative mb-6">
          <div className="absolute inset-0 rounded-2xl bg-linear-to-tr from-blue-600 to-cyan-400 blur-lg opacity-40 animate-pulse" />
